    ...
    >
      <div className="flex flex-row gap-[15px] items-center justify-center ml-14 md:ml-[0] mr-[51px] mt-[50px] w-[51%]">
        <div
          ...
          style={{ backgroundImage: "url('placeholder_image.svg')" }} // Use a placeholder image here
        >
          <Img
      ...
      >
        <div className="flex h-24 justify-end relative w-full">
          <div className="flex sm:flex-col flex-row sm:gap-5 h-full items-center justify-start w-full">
            <Img
              className="h-[22px]"
